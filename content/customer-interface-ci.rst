...
.. code-block:: bash
   ...
   sudo docker cp /tmp/Logos.png otobo_web_1:/opt/otobo/var/httpd/htdocs/skins/Customer/default/img/

**# Nativ installation in /opt/otobo/**

.. code-block:: bash

   sudo cp /tmp/Logos.png /opt/otobo/var/httpd/htdocs/skins/Customer/default/img/
